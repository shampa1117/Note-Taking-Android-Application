    ...
    (function(app) {
        ...
        var $selectItem = $('#selectItem'), 
             $title = $('#title'),
                ...
                notesitem = '<li data-role="list-divider">Your Item</li>',
                notesHdr = '<li data-role="list-divider">Your EXPNS</li>',
                noNotes = '<li id="noNotes">You have no Expns</li>';
        app.init = function() {
        ...
        app.checkForNotes = function() {
            ...
            if (!$.isEmptyObject(notes)) {
                ...
                $ul.html(notesitem+notesHdr + noNotes).listview('refresh');
            }
        };
        ...
        app.displayNotes = function() {
            ...
            $ul.html(notesitem + html).listview('refresh');
        };
        
        app.addNote = function(selectItem,title, note) {
            ...
            notesObj[selectItem.replace(/ /g, '-')] = note;
            notesObj[selectItem.replace(/ /g, '-')] = title;
